...
contract DopeModa {
    ...
    function codexRune(uint8 idx) public pure returns (uint16) {
        ...
        if (idx == 101) return 101;
        if (idx == 102) return 102;
        if (idx == 103) return 103;
        if (idx == 104) return 104;
        if (idx == 105) return 105;
        if (idx == 106) return 106;
        if (idx == 107) return 107;
        if (idx == 108) return 108;
        if (idx == 109) return 109;
        if (idx == 110) return 110;
        if (idx == 111) return 111;
        if (idx == 112) return 112;
        if (idx == 113) return 113;
        if (idx == 114) return 114;
        if (idx == 115) return 115;
        if (idx == 116) return 116;
        if (idx == 117) return 117;
        if (idx == 118) return 118;
        if (idx == 119) return 119;
        if (idx == 120) return 120;
        if (idx == 121) return 121;
        if (idx == 122) return 122;
        if (idx == 123) return 123;
        if (idx == 124) return 124;
        if (idx == 125) return 125;
        if (idx == 126) return 126;
        if (idx == 127) return 127;
        return 0;
    }

    function codexRuneMirror(uint8 idx) public pure returns (uint16) {
        // Mirror mapping for 0..63. Remaining values added next stage.
        if (idx == 0) return 127;
        if (idx == 1) return 126;
        if (idx == 2) return 125;
        if (idx == 3) return 124;
        ...
        if (idx == 8) return 119;
        if (idx == 9) return 118;
        if (idx == 10) return 117;
        if (idx == 11) return 116;
        if (idx == 12) return 115;
        if (idx == 13) return 114;
        if (idx == 14) return 113;
        if (idx == 15) return 112;
        if (idx == 16) return 111;
        if (idx == 17) return 110;
        if (idx == 18) return 109;
        if (idx == 19) return 108;
        if (idx == 20) return 107;
        if (idx == 21) return 106;
        if (idx == 22) return 105;
        if (idx == 23) return 104;
        if (idx == 24) return 103;
        if (idx == 25) return 102;
        if (idx == 26) return 101;
        if (idx == 27) return 100;
        if (idx == 28) return 99;
        if (idx == 29) return 98;
        if (idx == 30) return 97;
        if (idx == 31) return 96;
        ...
        if (idx == 98) return 29;
        if (idx == 99) return 28;
        if (idx == 100) return 27;
        if (idx == 101) return 26;
        if (idx == 102) return 25;
        if (idx == 103) return 24;
        if (idx == 104) return 23;
        if (idx == 105) return 22;
        if (idx == 106) return 21;
        if (idx == 107) return 20;
        if (idx == 108) return 19;
        if (idx == 109) return 18;
        if (idx == 110) return 17;
        if (idx == 111) return 16;
        if (idx == 112) return 15;
        if (idx == 113) return 14;
        if (idx == 114) return 13;
        if (idx == 115) return 12;
        if (idx == 116) return 11;
        if (idx == 117) return 10;
        if (idx == 118) return 9;
        if (idx == 119) return 8;
        if (idx == 120) return 7;
        if (idx == 121) return 6;
    ...
    function districtGlyphBps(uint16 zoneId) public pure returns (uint16) {
        // Uses only the zone modulo; keeps it deterministic for view/math.
        uint8 m = uint8(zoneId % 32);
        if (m == 0) return 0;
        if (m == 1) return 1;
        if (m == 2) return 2;
        if (m == 3) return 3;
    ...
    function rackGlyphBps(uint8 rackTier) public pure returns (uint16) {
        // Racket tier becomes a small deterministic fee/win-edge.
        if (rackTier == 0) return 0;
        if (rackTier == 1) return 1;
        if (rackTier == 2) return 2;
        if (rackTier == 3) return 3;
        if (rackTier == 4) return 4;
        if (rackTier == 5) return 5;
        if (rackTier == 6) return 6;
        if (rackTier == 7) return 7;
        if (rackTier == 8) return 8;
        if (rackTier == 9) return 9;
        if (rackTier == 10) return 10;
        if (rackTier == 11) return 11;
        if (rackTier == 12) return 12;
        if (rackTier == 13) return 13;
        if (rackTier == 14) return 14;
        if (rackTier == 15) return 15;
        return 0;
    }
}
